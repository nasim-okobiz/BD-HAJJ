  ...
  return (
    <div className="relative font-philo pt-2 sm:pt-28">
      ...
      <Containar>
        ...
        <div className="memberships sm:mt-10  bg-slate-200 p-5 mb-10 rounded-md ">
              ...
              {memberships?.map((membership, index) => (
                <SwiperSlide key={index}>
                  <div className="section__card  max-h-[550px] max-w-[300px] ">
                    ...
                    <img src={API_BASE_URL + membership?.photo} alt={membership?.name} className="h-28 w-28 mb-4 rounded-full" />
