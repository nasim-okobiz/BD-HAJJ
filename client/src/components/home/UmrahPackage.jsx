                  ...
                  <div className="w-full relative">
                    ...
                    <div className="absolute left-0 top-0 w-full h-full flex justify-center items-center">
                      <Link to={`package/${earlyBirdPackage?._id}`}>
                        <div>
                          <h2 className="text-[16px] xl:text-[24px] font-semibold text-center text-secondary">
                            {earlyBirdPackage.name}
                          </h2>
                          <h2 className="text-[16px] xl:text-[30px] text-semisecondary text-center font-semibold text-secondary-color font-century textshadow">
                          ...
                          <p className="text-[14px] xl:text-[16px] mt-2 px-2 sm:px-0 text-center mx-auto max-w-[360px]">
                            {earlyBirdPackage.hotalDistance.join(", ")}
                          </p>
                          <div className="mt-6 hidden sm:block">
                            {/* <HajjButton align={earlyBirdPackage?._id} /> */}
                            <Link to={`package/${earlyBirdPackage?._id}`}>
                              <button className="bg-primary text-white font-bold py-1 px-3 rounded transition-all duration-300 transform hover:scale-105 hover:shadow-md uppercase">
                                Book Now
                              </button>
                            </Link>
                          </div>
